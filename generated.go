...
const (
	...
	pairDefaultServicePairs = "kodo_default_service_pairs"
	// DefaultStoragePairs set default pairs for storager actions
	pairDefaultStoragePairs = "kodo_default_storage_pairs"
	// ServiceFeatures set service features
	pairServiceFeatures = "kodo_service_features"
	// StorageClass
	pairStorageClass = "kodo_storage_class"
	// StorageFeatures set storage features
	pairStorageFeatures = "kodo_storage_features"
)
...
type StorageFeatures struct {
	...
	VirtualPairWriteStorageClass bool
}
...
func (s *Storage) parsePairStorageWrite(opts []Pair) (pairStorageWrite, error) {
	...
	for _, v := range opts {
		...
		case pairStorageClass:
			...
			// If user enables the virtual pair feature, we can pass the virtual pair into it.
			if s.features.VirtualPairAll || s.features.VirtualPairWriteAll || s.features.VirtualPairWriteStorageClass {
